...
<div class="container-xxl py-5">
    <div class="container text-center">
        <iframe class="rounded iframe-size" src="https://www.youtube.com/embed/AJajnDb60_8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
    </div>
</div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <p>
                    Codefest promotes STEM for all. STEM as an acronym represents Science Technology Engineering and Mathematics and including the Arts. We are one of the pioneers of STEM education in Nigeria hosting CODEFEST Hackathon and Bootcamps across Nigeria impacting over 100,000 beneficiaries in schools, universities and neigbiurhoods. <br> <br> Apart from organizing the Codefest Nigeria Hackathon event, we also host CodeFest STEM Bootcamp and expo, these are aimed at promoting developments in Technical Education, thus positioning the country as the Information Technology hub in Africa. Our impact have attracted several states in Nigeria for a public-private partnership project in Lagos, Abuja, to name a few. We are currently working with Ebonyi state government to give access for digital transformation over the next 10 years. <br>
                    <br><br>Codefest is a movement. The vision has been the driver. Even after modifying and restructuring the vision still remains, so generations after us can have something that is:
                </p>
                <ol class="mb-4 ps-3">
                    <li>Build to last (the principle)</li>
                    <li>Problem Solving </li>
                    <li>Innovation management </li>
                    <li>Every person in CodeFest is a innovator </li>
...
<!-- Facilities Start -->
<div class="container-xxl py-5" id="school_facilities">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-6 col-lg-4 text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h6>Silicon Valley, Centenary City, Abakaliki, Ebonyi State, Nigeria.</h6>
            </div>
            <div class="col-md-6 col-lg-4 text-center wow fadeInUp" data-wow-delay="0.3s">
                <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-4" style="width: 75px; height: 75px;">
                    <i class="fa fa-envelope-open fa-2x text-primary"></i>
                </div>
                <h6>stem@codefestinternational.com</h6>
            </div>
            <div class="col-md-6 col-lg-4 text-center wow fadeInUp" data-wow-delay="0.5s">
                <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-4" style="width: 75px; height: 75px;">
                    <i class="fa fa-phone-alt fa-2x text-primary"></i>
                </div>
                <h6>+234 902 000 7572</h6>
            </div>
        </div>
        <div class="bg-light rounded">
            <div class="row g-0">
